...
process Meganize_BlastX_Contigs {
    ...
    tuple val(sample_id), file("${sample_id}_*.tsv"), emit: meganize_blastx_contigs_ch
    when:
    ...
    if [ "${params.metaspades}" == "true" ]; then
      ...
      diamond view --daa ${params.outdir}/${params.project_id}/${sample_id}/blast/${sample_id}_meta_contigs_blastx.daa > ${sample_id}_meta_contigs_blastx_diamondview.tsv
      ...
      diamond view --daa ${params.outdir}/${params.project_id}/${sample_id}/blast/${sample_id}_dragonflye_contigs_blastx.daa > ${sample_id}_dragonflye_contigs_blastx_diamondview.tsv
...
process Meganize_BlastX_Reads {
    ...
    if [ "${params.map2reads}" == "true" ]; then
      ...
      diamond view --daa ${params.outdir}/${params.project_id}/${sample_id}/blast/${sample_id}_reads_blastx.daa > ${sample_id}_reads_blastx_diamondview.tsv
